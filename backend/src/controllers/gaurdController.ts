...
import { extractQrToken } from '../services/qrService';
...
export const scanQRCode = async (
  ...
  try {
    ...
    const normalizedQrToken = extractQrToken(req.body.qrToken);
    const visitLookup = mongoose.isValidObjectId(normalizedQrToken)
      ? {
          $or: [
    ...
    const visit = await Visit.findOne(visitLookup)
